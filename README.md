...
- [X] Explain what a token is used for.
  ...
  A token is an object used like a ticket, to authenticate.

- [X] What steps can you take in your web apps to keep your data secure?

  Keep software and dependencies up to date! Keep code clean and free of old junk code and databases that might be used to hack into. Learn white-hat hacking, and try and break your app, to see vulnerabilities.
